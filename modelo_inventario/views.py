...
from numeros_aleatorios.views import op_metodo_lineal, metodo_multiplicativo
...
def modelo_inventario(request):
    if request.method == 'POST':
        ...
        if metodo == 'numeros':
            ...
            return render(request, 'modelo_inventario/index.html',
            ...
            for i in range(0, len(demanda[0])):
                l_deman.append({'valor': lvalor[i], 'px': lpx[i], "frecuencia": lfrecuen[i], "desde": ldesde[i],
                                "hasta": lhasta[i]})
            ...
            for i in range(0, len(retraso[0])):
                l_retra.append({'valor': lvalor[i], 'px': lpx[i], "frecuencia": lfrecuen[i], "desde": ldesde[i],
                                "hasta": lhasta[i]})
            ...
            return render(request, 'modelo_inventario/index.html', context)
