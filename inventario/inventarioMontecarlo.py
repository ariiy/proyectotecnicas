...
def inventarioMonte(R,Q,Inv,Co,Ch,Cf,Valor1Monte,Probabilidad1,valor2Monte,Probabilidad2,aleatorio_demanda,aleatorio_retraso):
	r=R
	q=Q
	inv=Inv
	co=Co
	...
	for i in range(0,len(deman)):
	    ...
	    lista_total.append({"n":n,"riDemanda":deman[i],"DemanMonte":vardeman,"inv":inicial,"ingresos":ingreso,"final":fin,"faltante":faltante,"mantener":mantener,"ordenar":ordenar,"RetraAlea":retra[i],"TiempoEntrega":varretra,"diaEntrega":diaentrega})
	    #print("")
